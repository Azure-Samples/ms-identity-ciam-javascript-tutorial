...
Function ConfigureApplications
{
   ...
   # create the application 
   $clientAadApplication = New-MgApplication -DisplayName "ciam-msal-angular-spa" `
                                                      -Spa `
                                                      @{ `
    ...
    Write-Host "Done creating the client application (ciam-msal-angular-spa)"
    ...
    Add-Content -Value "<tr><td>client</td><td>$currentAppId</td><td><a href='$clientPortalUrl'>ciam-msal-angular-spa</a></td></tr>" -Path createdApps.html
    ...
    # print the registered app portal URL for any further navigation
    Write-Host "Successfully registered and configured that app registration for 'ciam-msal-angular-spa' at `n $clientPortalUrl" -ForegroundColor Green 
    ...
    $dictionary = @{ "Enter_the_Tenant_Subdomain_Here" = $tenantName.Split(".onmicrosoft.com")[0]; "Enter_the_Application_Id_Here" = $serviceAadApplication.AppId; "Enter_the_Tenant_Id_Here" = $tenantId };
    ...
    $dictionary = @{ "Enter_the_Application_Id_Here" = $clientAadApplication.AppId; "Enter_the_Tenant_Subdomain_Here" = $tenantName.Split(".onmicrosoft.com")[0]; "Enter_the_Web_Api_Application_Id_Here" = $serviceAadApplication.AppId };
