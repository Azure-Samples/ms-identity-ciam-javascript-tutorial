...
public class ToDoListController : ControllerBase
{
    ...
    {
        if(IsAppMakingRequest() && !_toDoContext.ToDos.Any()) {
            _toDoContext.ToDos.Add(new ToDo() { Id = 1, Description = "Pick up grocerie", Owner = Guid.NewGuid() });
            _toDoContext.ToDos.Add(new ToDo() { Id = 2, Description = "Finish invoice report", Owner = Guid.NewGuid() });
            _toDoContext.ToDos.Add(new ToDo() { Id = 3, Description = "Water plants", Owner = Guid.NewGuid() });
